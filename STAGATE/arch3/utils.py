...
class MultimodalDataset(Dataset):
    def __init__(self, gene_data, protein_data, spatial_data):
    ...
    def __getitem__(self, index):
        gene = self.gene_data[index]
        protein = self.protein_data[index]
        spatial = self.spatial_data[index]
        return gene, protein, spatial
